  ...
  return (
    <Container>
      <div className=" relative flex gap-4 items-center h-[80vh] my-8 shadow-2xl p-[40px] overflow-hidden ">
        <div className=" w-[50%]">
          <h1 className=" text-[45px] lg:text-[45px] font-bold md:text-[35px] sm:text-[30px] sm:w-[60%] lg:w-[40%] text-orange-500">
            Tour Packages
          </h1>
          <p className=" lg:text-[20px] font-[400] md:text-[15px] sm:text-[12px] w-[70%]">
